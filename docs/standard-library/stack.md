...
Definiuje stos szablonów klas i dwa szablony pomocnicze.
...
> [!NOTE]
> \<stack>Biblioteka używa również `#include <initializer_list>` instrukcji.
...
|[>operatora ](../standard-library/stack-operators.md#op_gt)|Testuje, czy obiekt stosu po lewej stronie operatora jest większy niż obiekt stosu po prawej stronie.|
|[>operatora =](../standard-library/stack-operators.md#op_gt_eq)|Testuje, czy obiekt stosu po lewej stronie operatora jest większy niż lub równy obiektowi stosu po prawej stronie.|
