---
description: 'Dowiedz się więcej na temat: &lt; cfenv&gt;'
title: '&lt;cfenv&gt;'
ms.date: 11/04/2016
...
ms.locfileid: "97325292"
---
# <a name="ltcfenvgt"></a>&lt;cfenv&gt;

Zawiera nagłówek standardowej biblioteki C \<fenv.h> i dodaje skojarzone nazwy do `std` przestrzeni nazw.
