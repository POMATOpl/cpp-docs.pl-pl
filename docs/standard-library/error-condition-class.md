---
description: Dowiedz się więcej na temat klasy error_condition
...
|Nazwa|Opis|
|-|-|
|[ponownie](#assign)|Przypisuje wartość kodu błędu i kategorię do warunku błędu.|
