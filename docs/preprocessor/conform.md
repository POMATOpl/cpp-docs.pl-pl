---
description: 'Dowiedz się więcej na temat: zgodność dyrektywy pragma'
...
> **#pragma zgodności (** *Nazwa* [ **, show** ] [ **,** { **on**  |  **off** }] [[ **,** { **push**  |  **pop** }] [ **,** *Identyfikator* [ **,** { **on**  |  **off** }]]] **)**
