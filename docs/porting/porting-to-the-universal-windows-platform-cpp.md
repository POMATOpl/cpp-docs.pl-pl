---
description: 'Dowiedz się więcej: przenoszenie do platforma uniwersalna systemu Windows (C++)'
...
Dokumentacja Centrum deweloperów systemu Windows zawiera Przewodnik przenoszenia Windows 8.1 aplikacji do platforma uniwersalna systemu Windows. Zobacz [przechodzenie z środowisko wykonawcze systemu Windows 8 do platformy UWP](/windows/uwp/porting/w8x-to-uwp-root). Chociaż przewodnik koncentruje się głównie na kodzie C#, większość wskazówek ma zastosowanie do języka C++. Poniższe procedury zawierają bardziej szczegółowe informacje. Zobacz również [przenoszenie z aplikacji klasycznej do platformy UWP](/windows/uwp/porting/desktop-to-uwp-migrate).
...
Jeśli masz klasyczny plik Win32 DLL i chcesz go wywołać z aplikacji platformy UWP, możesz to zrobić. Korzystając z tych procedur, można utworzyć warstwę interfejsu użytkownika platformy UWP dla istniejącej klasycznej aplikacji Windows Desktop C++ lub międzyplatformowego standardowego kodu C++. Zobacz [jak: korzystanie z istniejącego kodu C++ w aplikacji platforma uniwersalna systemu Windows](../porting/how-to-use-existing-cpp-code-in-a-universal-windows-platform-app.md).
...
1. Otwórz okno **właściwości projektu** i w sekcji **C++**  >  **General (ogólne**) ustaw zestaw **narzędzi platformy** na **najnowsze 141**, zestawu narzędzi dla programu Visual Studio 2017.

1. Kompiluj projekt jako projekt Windows 8.1 i rozwiąż wszelkie błędy kompilacji. Wszelkie błędy na tym etapie prawdopodobnie są spowodowane istotnymi zmianami w narzędziach i bibliotekach kompilacji. Zobacz [Visual C++ historię zmian 2003-2015](../porting/visual-cpp-change-history-2003-2015.md) , aby uzyskać szczegółowy opis zmian, które mogą wpływać na kod.
...
1. Jeśli nie używasz tej samej nazwy projektu, co stary projekt, Otwórz plik Package. appxmanifest i zaktualizuj **punkt wejścia** , aby odzwierciedlał nazwę przestrzeni nazw dla `App` klasy.

   Pole **punkt wejścia** w pliku Package. appxmanifest zawiera nazwę zakresu dla `App` klasy, która obejmuje przestrzeń nazw, która zawiera `App` klasę. Podczas tworzenia projektu uniwersalnego systemu Windows przestrzeń nazw jest ustawiana na nazwę projektu. Jeśli różni się od plików, które zostały skopiowane ze starego projektu, należy zaktualizować jeden lub drugi w celu dopasowania.
...
[Przewodnik dotyczący przenoszenia Visual C++](../porting/porting-to-the-universal-windows-platform-cpp.md)<br/>
