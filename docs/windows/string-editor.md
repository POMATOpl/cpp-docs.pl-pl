---
description: 'Dowiedz się więcej: Edytor ciągów (C++)'
...
**Edytor ciągów** gwarantuje, że nie używasz identyfikatora, który jest już używany. Jeśli wybierzesz identyfikator, który jest już używany, **Edytor ciągów** wyświetli powiadomienie, a następnie przypisze ogólny unikatowy identyfikator, na przykład `IDS_STRING58113` .
