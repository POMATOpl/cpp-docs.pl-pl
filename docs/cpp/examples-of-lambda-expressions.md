---
description: 'Dowiedz się więcej o: Przykłady wyrażeń lambda'
...
## <a name="higher-order-lambda-functions"></a><a name="higherOrderLambdaExpressions"></a> Higher-Order funkcje lambda
