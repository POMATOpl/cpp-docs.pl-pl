---
description: 'Dowiedz się więcej o: pisania filtru wyjątków'
...
Zwróć uwagę na użycie elementu [GetExceptionCode](/windows/win32/Debug/getexceptioncode) w celu określenia wyjątku. Musisz wywołać tę funkcję wewnątrz samego filtru. `Eval_Exception` nie można wywołać metody `GetExceptionCode` , ale musi ona mieć do niej kod wyjątku.
