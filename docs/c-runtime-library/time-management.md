---
description: 'Dowiedz się więcej o programie: zarządzanie czasem'
...
|[Zegarek](../c-runtime-library/reference/clock.md)|Zwróć czas, który upłynął dla procesu.|
