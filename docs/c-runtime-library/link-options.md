---
description: 'Dowiedz się więcej o programie: opcje łączy'
title: Opcje łącz
ms.date: 11/04/2016
helpviewer_keywords:
- nothrownew.obj
...
|chkstk.obj|n/d|Zapewnia obsługę sprawdzania stosu i alloca, gdy nie jest używany CRT.|
...
|exe_initialize_mta. lib|n/d|Inicjuje Apartament komórki MTA podczas uruchamiania programu EXE, co umożliwia korzystanie z obiektów COM w globalnych wskaźnikach inteligentnych. Ponieważ ta opcja powoduje przeciek odwołania do komórki MTA podczas zamykania, nie należy używać go dla bibliotek DLL. Łączenie z tym jest równoważne z uwzględnieniem współdziałania. h i definiowania _EXE_INITIALIZE_MTA. |
|fp10.obj|n/d|Zmienia domyślny formant dokładności na 64 bitów. Zobacz [obsługę zmiennoprzecinkową](../c-runtime-library/floating-point-support.md).|
