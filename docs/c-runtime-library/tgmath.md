...
Windows SDK w wersji 10.0.20201.0 lub nowszej. Jest to obecnie kompilacja niejawnego programu testów, którą można pobrać z [wersji zapoznawczej programu testów systemu Windows](https://www.microsoft.com/software-download/windowsinsiderpreviewSDK). Zobacz [C11 i C17: wprowadzenie,](https://devblogs.microsoft.com/cppblog/c11-and-c17-standard-support-arriving-in-msvc/#c11-and-c17-getting-started) Aby uzyskać instrukcje dotyczące instalowania i używania tego zestawu SDK.

## <a name="see-also"></a>Zobacz także

[Dokumentacja biblioteki języka C Run-Time](c-run-time-library-reference.md)
