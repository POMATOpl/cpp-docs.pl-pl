---
description: 'Dowiedz się więcej: Klasyfikacja bajtów'
...
|[_ismbbprint, _ismbbprint_l](../c-runtime-library/reference/ismbbprint-ismbbprint-l.md)|**_ismbbkprint** &#124;&#124; **isprint** . **ismbbprint** zawiera znak spacji (0x20)|
...
Makro **MB_LEN_MAX** zdefiniowane w programie \<limits.h> rozszerza maksymalną długość w bajtach, jaką może mieć dowolny znak wielobajtowy. **MB_CUR_MAX**, zdefiniowany w \<stdlib.h> , rozszerza maksymalną długość w bajtach dowolnego znaku wielobajtowego w bieżącym ustawieniach regionalnych.
