---
description: 'Dowiedz się więcej na temat: _vcprintf, _vcprintf_l, _vcwprintf _vcwprintf_l'
...
Każda z tych funkcji Pobiera wskaźnik do listy argumentów, a następnie formatuje i zapisuje dane w konsoli. **_vcwprintf** to wersja znaku dwubajtowego **_vcprintf**. Ciąg znaków dwubajtowych przyjmuje jako argument.
