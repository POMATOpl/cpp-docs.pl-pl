---
description: 'Dowiedz się więcej na temat: _scprintf_p, _scprintf_p_l, _scwprintf_p _scwprintf_p_l'
...
Różnica między **_scprintf_p** i **_scprintf** jest tym, że **_scprintf_p** obsługuje parametry pozycyjne, które umożliwiają określanie kolejności, w której argumenty są używane w ciągu formatu. Aby uzyskać więcej informacji, zobacz [Printf_p parametry pozycyjne](../../c-runtime-library/printf-p-positional-parameters.md).
