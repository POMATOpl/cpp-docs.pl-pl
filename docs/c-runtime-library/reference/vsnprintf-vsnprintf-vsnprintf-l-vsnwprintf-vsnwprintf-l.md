...
## <a name="example-use-wide-characters-with-_vsnwprintf"></a>Przykład: Użyj znaków dwubajtowych z `_vsnwprintf()`
...
## <a name="example-use-vsnprintf-with-narrow-strings"></a>Przykład: Użyj `vsnprintf()` z wąskimi ciągami
