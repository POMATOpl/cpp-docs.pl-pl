---
description: 'Dowiedz się więcej na temat: fread'
title: fread
ms.date: 4/2/2020
api_name:
- fread
...
Zobacz [ \_ doserrno, errno, \_ sys \_ errlist i \_ sys \_ NERR,](../../c-runtime-library/errno-doserrno-sys-errlist-and-sys-nerr.md) Aby uzyskać więcej informacji na temat tych kodów błędów.
