---
description: 'Dowiedz się więcej na temat: _vcprintf_s, _vcprintf_s_l, _vcwprintf_s _vcwprintf_s_l'
...
Każda z tych funkcji Pobiera wskaźnik do listy argumentów, a następnie formatuje i zapisuje dane w konsoli. **_vcwprintf_s** to wersja znaku dwubajtowego **_vcprintf_s**. Ciąg znaków dwubajtowych przyjmuje jako argument.
