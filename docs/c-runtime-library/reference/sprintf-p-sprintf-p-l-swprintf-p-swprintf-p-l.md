---
description: 'Dowiedz się więcej na temat: _sprintf_p, _sprintf_p_l, _swprintf_p _swprintf_p_l'
...
## <a name="example-use-_sprintf_p-to-format-data"></a>Przykład: Użyj _sprintf_p, aby sformatować dane
