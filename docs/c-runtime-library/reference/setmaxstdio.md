---
description: 'Dowiedz się więcej na temat: _setmaxstdio'
title: _setmaxstdio
ms.date: 05/21/2019
api_name:
- _setmaxstdio
...
Zwraca *new_max* , jeśli się powiedzie; -1 w przeciwnym razie.
...
Zobacz [_getmaxstdio](getmaxstdio.md) , aby zapoznać się z przykładem **_setmaxstdio**.
