...
- `call_as`
  ...
  Określa nazwę metody zdalnej, do której można zamapować tę metodę lokalną. Aby uzyskać więcej informacji, zobacz [call_as](/windows/win32/Midl/call-as) w *MIDL Reference*.
