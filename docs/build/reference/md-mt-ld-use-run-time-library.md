---
description: Dowiedz się więcej o:/MD,/MT,/LD (Użyj biblioteki Run-Time)
title: /MD,-MT,-LD (Użyj biblioteki Run-Time)
ms.date: 07/17/2019
f1_keywords:
- /ld
- /mt
...
Aby uzyskać więcej informacji na temat korzystania z wersji debugowania bibliotek czasu wykonywania, zobacz [Dokumentacja biblioteki języka C Run-Time](../../c-runtime-library/c-run-time-library-reference.md).
