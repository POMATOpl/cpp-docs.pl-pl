---
description: Dowiedz się więcej o typach plików utworzonych dla projektów Visual Studio C++
title: Typy plików utworzone dla projektów Visual Studio C++
ms.date: 04/08/2019
helpviewer_keywords:
...
ms.locfileid: "97200588"
---
# <a name="file-types-created-for-visual-studio-c-projects"></a>Typy plików utworzone dla projektów Visual Studio C++
...
|. ASP|Źródło|Plik stronicowania Active Server.|
...
|. cpp,. c|Źródło|Główne pliki kodu źródłowego aplikacji.|
|. CUR|Zasób|Plik graficzny kursora mapy bitowej.|
|. DBP|Project|Plik projektu bazy danych.|
|. disco|Źródło|Plik dokumentu odnajdywania dynamicznego. Obsługuje odnajdywanie usług sieci Web XML.|
|. exe,. dll|Project|Pliki bibliotek wykonywalnych lub dynamicznych.|
|. h|Źródło|Plik nagłówka (include).|
...
|. vcxitems|Project|Projekt elementów udostępnionych do udostępniania plików kodu między wieloma projektami C++. Aby uzyskać więcej informacji, zobacz [pliki projektu i rozwiązania](project-and-solution-files.md).|
...
[Tworzenie projektów Visual Studio C++ i zarządzanie nimi](../creating-and-managing-visual-cpp-projects.md)<br>
[Typy projektów Visual Studio C++](visual-cpp-project-types.md)<br>
