...
description: 'Dowiedz się więcej na temat opcji kompilatora Microsoft C++/Zc: noexceptTypes w przypadku zgodności z kodem źródłowym języka C++ 17 noexcept.'
ms.date: 06/04/2020
f1_keywords:
- /Zc:noexceptTypes
helpviewer_keywords:
