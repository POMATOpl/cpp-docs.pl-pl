---
description: 'Dowiedz się więcej na temat: korzystanie z korzystanie CAnimateCtrl'
...
- [Korzystanie z kontrolki animacji](../mfc/using-an-animation-control.md)
