---
description: 'Dowiedz się więcej o: kontrolkach ActiveX MFC'
...
Istnieją także przykłady dla kontrolek ActiveX MFC. Aby uzyskać więcej informacji na temat tych przykładów, zobacz [Control Samples: MFC-Based ActiveX Controls](../overview/visual-cpp-samples.md)
