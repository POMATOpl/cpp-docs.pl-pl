...
Ta sekcja dokumentuje struktury, style i funkcje wywołania zwrotnego używane przez biblioteka MFC i mapy komunikatów MFC.

## <a name="in-this-section"></a>W tej sekcji

[Struktury używane przez MFC](../../mfc/reference/structures-used-by-mfc.md)<br/>
Oferuje linki do struktur wywoływanych z różnych funkcji składowych.
...
Zawiera łącza do przykładów, które demonstrują korzystanie z biblioteki MFC.
