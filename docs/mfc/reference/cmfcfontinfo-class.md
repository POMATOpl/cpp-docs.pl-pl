---
description: 'Dowiedz się więcej na temat: Klasa CMFCFontInfo'
...
W poniższym przykładzie pokazano, jak używać różnych elementów członkowskich `CMFCFontInfo` klasy. W przykładzie pokazano, jak uzyskać `CMFCFontInfo` obiekt z `CMFCRibbonFontComboBox` i, jak uzyskać dostęp do zmiennych lokalnych. Ten przykład jest częścią [przykładu demonstracyjnego na MSOffice 2007](../../overview/visual-cpp-samples.md).
...
*Npowiadomienia*<br/>
podczas Wartość, która określa typ czcionki. Ten parametr może być kombinacją bitową (lub) DEVICE_FONTTYPE, RASTER_FONTTYPE i TRUETYPE_FONTTYPE.
