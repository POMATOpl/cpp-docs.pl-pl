---
description: 'Dowiedz się więcej na temat: Klasa CCheckListBox'
...
Obiekt jest konstruowany `CCheckListBox` w dwóch krokach. Najpierw Zdefiniuj klasę pochodną `CCheckListBox` , a następnie Wywołaj `Create` , która inicjuje pole listy kontrolnej systemu Windows i dołącza go `CCheckListBox` do obiektu.
...
Obiekt jest konstruowany `CCheckListBox` w dwóch krokach. Najpierw Zdefiniuj klasę pochodną od, `CcheckListBox` a następnie Wywołaj `Create` , która inicjuje pole listy kontrolnej systemu Windows i dołącza go `CCheckListBox` do. Aby uzyskać przykład, zobacz [CCheckListBox:: CCheckListBox](#cchecklistbox) .

Gdy jest `Create` wykonywane, system Windows wysyła wiadomości [WM_NCCREATE](../../mfc/reference/cwnd-class.md#onnccreate), [WM_CREATE](../../mfc/reference/cwnd-class.md#oncreate), [WM_NCCALCSIZE](../../mfc/reference/cwnd-class.md#onnccalcsize)i [WM_GETMINMAXINFO](../../mfc/reference/cwnd-class.md#ongetminmaxinfo) do kontrolki pole listy kontrolnej.
...
## <a name="cchecklistboxgetcheckstyle"></a><a name="getcheckstyle"></a> CCheckListBox:: getchecks
...
## <a name="cchecklistboxsetcheckstyle"></a><a name="setcheckstyle"></a> CCheckListBox:: setchecks
