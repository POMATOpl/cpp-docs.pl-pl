---
description: 'Dowiedz się więcej na temat: klasy MFC'
title: Klasy MFC
ms.date: 11/04/2016
helpviewer_keywords:
- MFC, classes
...
[Klasa korzystanie CAnimateCtrl](../../mfc/reference/canimatectrl-class.md)<br/>
...
Używane tylko wewnątrz `ON_UPDATE_COMMAND_UI` procedury obsługi w `CCmdTarget` klasie pochodnej.
...
[Klasa korzystanie CComboBoxEx](../../mfc/reference/ccomboboxex-class.md)<br/>
...
Klasa bazowa klasy `CD2DLinearGradientBrush` i `CD2DRadialGradientBrush` .
...
Klasa abstrakcyjna, która udostępnia interfejs do tworzenia `D2D` zasobów, takich jak pędzle, warstwy i teksty, oraz zarządzania nimi.
...
[Klasa korzystanie CDateTimeCtrl](../../mfc/reference/cdatetimectrl-class.md)<br/>
...
[Klasa korzystanie CImageList](../../mfc/reference/cimagelist-class.md)<br/>
...
Implementuje pasek stanu podobny do `CStatusBar` klasy. Jednak `CMFCStatusBar` Klasa ma funkcje, które nie są oferowane przez `CStatusBar` klasę, takie jak możliwość wyświetlania obrazów, animacji i pasków postępu, a także możliwość reagowania na dwukrotne kliknięcie myszą.
...
[Klasa metody COleDocObjectItem](../../mfc/reference/coledocobjectitem-class.md)<br/>
...
[Klasa element COleTemplateServer](../../mfc/reference/coletemplateserver-class.md)<br/>
...
[Klasa CPoint](../../atl-mfc-shared/reference/cpoint-class.md)<br/>
...
[Klasa korzystanie CProgressCtrl](../../mfc/reference/cprogressctrl-class.md)<br/>
...
[Klasa formularzy CRecordView](../../mfc/reference/crecordview-class.md)<br/>
Widok, w którym są wyświetlane rekordy bazy danych w kontrolkach.
...
[Klasa CSize](../../atl-mfc-shared/reference/csize-class.md)<br/>
...
[Klasa korzystanie CSliderCtrl](../../mfc/reference/csliderctrl-class.md)<br/>
...
[Klasa korzystanie CSpinButtonCtrl](../../mfc/reference/cspinbuttonctrl-class.md)<br/>
...
Reprezentuje plik strumienia uruchomieniowego C, który został otwarty przez funkcję uruchomieniową [fopen, _wfopen](../../c-runtime-library/reference/fopen-wfopen.md).
