---
description: 'Dowiedz się więcej na temat: Klasa CMFCToolBarDateTimeCtrl'
...
|[CMFCToolBarDateTimeCtrl:: onkliknięcia](#onclick)|Wywoływane przez platformę, gdy użytkownik kliknie formant. (Przesłania [CMFCToolBarButton:: onkliknięciu](../../mfc/reference/cmfctoolbarbutton-class.md#onclick).)|
...
*iImage*<br/>
podczas Indeks obrazu w obiekcie paska narzędzi `CMFCToolBarImages` .
...
`CMFCToolBarDateTimeCtrl`Klasa inicjuje `m_pWndDateTime` element członkowski danych podczas wstawiania `CMFCToolBarDateTimeCtrl` obiektu do paska narzędzi.
...
## <a name="cmfctoolbardatetimectrlonclick"></a><a name="onclick"></a> CMFCToolBarDateTimeCtrl:: onkliknięcia
...
Ta metoda przesłania domyślną implementację klasy ( [CMFCToolBarButton:: OnMove](../../mfc/reference/cmfctoolbarbutton-class.md#onmove)) przez zaktualizowanie pozycji `CMFCToolBarDateTimeCtrlImpl` obiektu wewnętrznego.
...
Ta metoda przesłania domyślną implementację klasy ( [CMFCToolBarButton:: OnSize](../../mfc/reference/cmfctoolbarbutton-class.md#onsize)) przez zaktualizowanie rozmiaru i położenia `CMFCToolBarDateTimeCtrlImpl` obiektu wewnętrznego.
