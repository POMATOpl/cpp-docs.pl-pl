---
description: 'Dowiedz się więcej na temat: Klasa CAnimationVariable'
...
## <a name="canimationvariablecreatetransitions"></a><a name="createtransitions"></a> CAnimationVariable:: settransitions
...
S_OK, czy wartość została pobrana pomyślnie, lub zmienna animacji bazowa nie została utworzona. Kod błędu HRESULT w przeciwnym razie.
