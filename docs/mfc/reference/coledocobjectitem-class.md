---
description: 'Dowiedz się więcej na temat: Klasa metody COleDocObjectItem'
...
|Nazwa|Opis|
|----------|-----------------|
|[Metody COleDocObjectItem:: metody COleDocObjectItem](#coledocobjectitem)|Tworzy `COleDocObject` element.|
...
|[Metody COleDocObjectItem:: getpagecount](#getpagecount)|Pobiera liczbę stron w dokumencie aplikacji kontenera.|
|[Metody COleDocObjectItem:: OnPreparePrinting](#onprepareprinting)|Przygotowuje dokument kontenera do drukowania.|
|[Metody COleDocObjectItem:: OnPrint](#onprint)|Drukuje dokument aplikacji kontenera.|
...
- `COleDocument`Klasa pochodna nadal zachowuje listę aktualnie osadzonych elementów, ale te elementy mogą być `COleDocObjectItem` elementami pochodnymi.
...
Ponieważ kontener dokumentów aktywnych jest własnością menu **Pomoc** , kontener jest odpowiedzialny za przekazywanie komunikatów menu **pomocy** serwera do serwera. Ta integracja jest obsługiwana przez program `COleDocObjectItem` .
...
## <a name="coledocobjectitemcoledocobjectitem"></a><a name="coledocobjectitem"></a> Metody COleDocObjectItem:: metody COleDocObjectItem

Wywołaj tę funkcję elementu członkowskiego, aby zainicjować `COleDocObjectItem` obiekt.
...
*pContainerDoc*<br/>
Wskaźnik do `COleDocument` obiektu działającego jako kontener aktywnego dokumentu. Aby można było włączyć IMPLEMENT_SERIALIZE, ten parametr musi mieć wartość NULL. Normalne elementy OLE są konstruowane przy użyciu wskaźnika dokumentu o wartości innej niż NULL.

## <a name="coledocobjectitemdodefaultprinting"></a><a name="dodefaultprinting"></a> Metody COleDocObjectItem::D oDefaultPrinting
...
## <a name="coledocobjectitemexeccommand"></a><a name="execcommand"></a> Metody COleDocObjectItem:: ExecCommand
...
Zwraca S_OK, jeśli się powiedzie; w przeciwnym razie zwraca jeden z następujących kodów błędów.
...
## <a name="coledocobjectitemgetactiveview"></a><a name="getactiveview"></a> Metody COleDocObjectItem:: GetActiveView
...
## <a name="coledocobjectitemgetpagecount"></a><a name="getpagecount"></a> Metody COleDocObjectItem:: getpagecount
...
## <a name="coledocobjectitemonprepareprinting"></a><a name="onprepareprinting"></a> Metody COleDocObjectItem:: OnPreparePrinting
...
## <a name="coledocobjectitemonprint"></a><a name="onprint"></a> Metody COleDocObjectItem:: OnPrint
...
## <a name="coledocobjectitemquerycommand"></a><a name="querycommand"></a> Metody COleDocObjectItem:: QueryCommand
...
## <a name="coledocobjectitemrelease"></a><a name="release"></a> Metody COleDocObjectItem:: Release
