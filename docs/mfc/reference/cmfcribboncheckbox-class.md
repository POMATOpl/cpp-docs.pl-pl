---
description: 'Dowiedz się więcej na temat: Klasa CMFCRibbonCheckBox'
...
ms.locfileid: "97293745"
---
# <a name="cmfcribboncheckbox-class"></a>Klasa CMFCRibbonCheckBox

`CMFCRibbonCheckBox`Klasa implementuje pole wyboru, które można dodać do panelu wstążki, paska narzędzi Szybki dostęp lub menu podręcznego.
...
Poniższy przykład ilustruje sposób konstruowania obiektu `CMFCRibbonCheckBox` klasy.
...
Zwraca `CSize` obiekt, który zawiera rozmiar kompaktowy pola wyboru.
...
`CSize`Obiekt zawierający rozmiar pośredni pola wyboru.
...
*CRect*<br/>
podczas `CRect` Obiekt określający prostokąt, w którym ma zostać narysowany obraz menu.
