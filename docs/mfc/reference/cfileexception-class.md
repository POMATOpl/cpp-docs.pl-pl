---
description: 'Dowiedz się więcej na temat: Klasa CFileException'
...
*nErrno*<br/>
Kod błędu liczby całkowitej, zgodnie z definicją w pliku dołączanego w czasie wykonywania ERRNO. H.
