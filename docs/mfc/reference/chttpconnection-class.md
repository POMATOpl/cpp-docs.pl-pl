---
description: 'Dowiedz się więcej na temat: Klasa CHttpConnection'
...
Ta funkcja członkowska jest wywoływana w celu skonstruowania `CHttpConnection` obiektu.
...
*dwContext*<br/>
Identyfikator kontekstu dla `CInternetConnection` obiektu. Aby uzyskać więcej informacji na temat *dwContext*, zobacz sekcję **uwagi** .
...
*flagiDW*<br/>
Dowolna kombinacja `INTERNET_FLAG_*` flag. Zapoznaj się z tabelą w sekcji **spostrzeżenia** elementu [CHttpConnection:: OpenRequest](#openrequest) , aby uzyskać opis wartości *flagiDW* .

### <a name="remarks"></a>Uwagi

Nigdy nie utworzysz `CHttpConnection` bezpośredniego. Zamiast tego należy utworzyć obiekt przez wywołanie [CInternetSession:: GetHttpConnection](../../mfc/reference/cinternetsession-class.md#gethttpconnection).
...
*dwContext*<br/>
Identyfikator kontekstu dla `OpenRequest` operacji. Aby uzyskać więcej informacji na temat *dwContext*, zobacz sekcję Uwagi.
...
*nVerb*<br/>
Liczba skojarzona z typem żądania HTTP. Może być jedną z następujących czynności:
