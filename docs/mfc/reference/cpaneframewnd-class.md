---
description: 'Dowiedz się więcej na temat: Klasa CPaneFrameWnd'
...
|[CPaneFrameWnd::D ockPane](#dockpane)|Dokowanie okienka.|
...
Struktura automatycznie tworzy obiekt, `CPaneFrameWnd` gdy okienko jest przełączane ze stanu zadokowanego do stanu zmiennoprzecinkowego.
...
## <a name="cpaneframewndaddpane"></a><a name="addpane"></a> CPaneFrameWnd:: Add— okienko
...
Okno mini jest tworzone w dwóch krokach. Po pierwsze, struktura tworzy `CPaneFrameWnd`  obiekt. Drugi wywołuje, `Create` Aby utworzyć okno mini systemu Windows i dołączyć je do `CPaneFrameWnd` obiektu.
...
Jeśli operacja zakończyła się pomyślnie, to `CDockablePane` okienko zostało zadokowane; w przeciwnym razie wartość null.
...
Wywołaj tę metodę, aby określić wysokość okna mini-frame. Domyślnie wysokość jest ustawiona na SM_CYSMCAPTION. Aby uzyskać więcej informacji, zobacz [Funkcja GetSystemMetrics](/windows/win32/api/winuser/nf-winuser-getsystemmetrics).
...
## <a name="cpaneframewndgetpane"></a><a name="getpane"></a> CPaneFrameWnd:: getokienk
...
## <a name="cpaneframewndpin"></a><a name="pin"></a> CPaneFrameWnd::P w
