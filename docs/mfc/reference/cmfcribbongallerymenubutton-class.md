---
description: 'Dowiedz się więcej na temat: Klasa CMFCRibbonGalleryMenuButton'
...
## <a name="cmfcribbongallerymenubuttongetpalette"></a><a name="getpalette"></a> CMFCRibbonGalleryMenuButton:: getpaleta
