---
description: 'Dowiedz się więcej na temat: Klasa CBitmapButton'
...
Wskazuje ciąg zakończony znakiem null, który zawiera nazwę mapy bitowej dla stanu normalnego lub "w górę" przycisku mapy bitowej. Wymagane.
...
Określa numer identyfikatora zasobu mapy bitowej przycisku "normalny" lub "w górę". Wymagane.
