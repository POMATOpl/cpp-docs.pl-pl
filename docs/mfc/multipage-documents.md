---
description: 'Dowiedz się więcej na temat: dokumenty wielostronicowe'
...
## <a name="print-time-pagination"></a><a name="_core_print.2d.time_pagination"></a> Print-Time podział na strony
...
- [Przydzielanie zasobów interfejsu GDI](allocating-gdi-resources.md)
