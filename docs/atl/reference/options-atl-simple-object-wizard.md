---
description: 'Dowiedz się więcej o: opcje, Kreator prostych obiektów ATL'
...
- **Model wątkowości**
   ...
   |Opcja|Opis|
   |------------|-----------------|
   |**Pojedyncze**|Określa, że obiekt jest zawsze uruchamiany w podstawowym wątku COM. Aby uzyskać więcej informacji, zobacz apartamentach i [InprocServer32](/windows/win32/com/inprocserver32) o [pojedynczym wątku](/windows/win32/com/single-threaded-apartments) .|
...
- **Interfejs**
   ...
   |Opcja|Opis|
   |------------|-----------------|
   |**Podwójne**|Określa, że obiekt obsługuje podwójny interfejs (jego tablicę zawierającą niestandardowe funkcje interfejsu i metody późnego wiązania `IDispatch` ). Zezwala na dostęp do obiektu zarówno klientom COM, jak i [kontrolerom automatyzacji](../../mfc/automation-clients.md) . Domyślnie.|
