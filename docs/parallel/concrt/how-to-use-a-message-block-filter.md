---
description: 'Dowiedz się więcej na temat: jak używać filtru bloku komunikatów'
...
## <a name="example-count_primes-function"></a>Przykład: funkcja count_primes
...
## <a name="example-count_primes_filter-function"></a>Przykład: funkcja count_primes_filter
...
## <a name="example-finished-message-block-filter-code-sample"></a>Przykład: zakończono przykładowy kod filtru bloku komunikatów
