---
description: 'Dowiedz się więcej o tym, jak: konwertowanie pętli OpenMP używającej obsługi wyjątków do korzystania z środowisko uruchomieniowe współbieżności'
