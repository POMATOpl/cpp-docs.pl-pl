---
description: 'Dowiedz się więcej na temat: Przewodnik: debugowanie aplikacji C++ AMP'
...
1. W oknie dialogowym **strony właściwości** w obszarze **Właściwości konfiguracji** Wybierz wstępnie skompilowane nagłówki **C/C++**  >  .
