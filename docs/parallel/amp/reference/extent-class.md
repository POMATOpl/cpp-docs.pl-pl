---
description: Dowiedz się więcej o klasie zakresów (C++ AMP)
...
|[tabliczek](#tile)|Tworzy `tiled_extent` obiekt z zakresem kafelków przyznanych przez określone wymiary.|
