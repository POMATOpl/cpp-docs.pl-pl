---
description: 'Dowiedz się więcej o: Ostrzeżenie kompilatora (poziom 1) C4947'
...
ms.locfileid: "97327980"
---
# <a name="compiler-warning-level-1-c4947"></a>Ostrzeżenie kompilatora (poziom 1) C4947

"type_or_member": oznaczono jako przestarzały

Element członkowski lub typ został oznaczony jako przestarzały z <xref:System.ObsoleteAttribute> klasą.
