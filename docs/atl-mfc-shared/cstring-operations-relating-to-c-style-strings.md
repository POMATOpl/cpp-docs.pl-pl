---
description: 'Dowiedz się więcej o: operacjach CString odnoszących się do ciągów w stylu C'
...
## <a name="using-cstring-as-a-c-style-null-terminated-string"></a><a name="_core_using_cstring_as_a_c.2d.style_null.2d.terminated_string"></a> Używanie CString jako ciągu Null-Terminated w stylu C
...
## <a name="working-with-standard-run-time-library-string-functions"></a><a name="_core_working_with_standard_run.2d.time_library_string_functions"></a> Praca z funkcjami ciągu biblioteki standardowej Run-Time
